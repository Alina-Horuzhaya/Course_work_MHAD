...
{
    public partial class del_ind : Form
    {
        ...
        private void button_delete_Click(object sender, EventArgs e)
        {
            ...
            {
                string message = "Поле \"ID Показателя\" не заполнено";
            ...
            else
            {
                ...
                try
                {
                    ...
                    cmd.CommandText = "DELETE FROM indicators WHERE idindicators = @id;"; //если таблица отсутствует, создает
