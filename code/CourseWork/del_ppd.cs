...
{
    public partial class del_ppd : Form
    {
        ...
        private void button_delete_Click(object sender, EventArgs e)
        {
            ...
            {
                string message = "Поле \"ID прогноза % брака\" не заполнено";
            ...
            else
            {
                ...
                try
                {
                    ...
                    cmd.CommandText = "DELETE FROM prediction_percent_defect WHERE idprediction_percent_defect = @id;"; //если таблица отсутствует, создает
