...
{
    public partial class del_prov : Form
    {
        ...
        private void button_delete_Click(object sender, EventArgs e)
        {
            ...
            {
                string message = "Поле \"Номер машины\" не заполнено";
            ...
            else
            {
                ...
                try
                {
                    ...
                    cmd.CommandText = "DELETE FROM provider WHERE idprovider = @id;"; //если таблица отсутствует, создает
