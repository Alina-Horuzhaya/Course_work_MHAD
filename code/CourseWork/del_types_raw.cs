...
{
    public partial class del_types_raw : Form
    {
        SQL_connector connector;
        public del_types_raw()
        {
            InitializeComponent();
        ...
        private void button_del_Click(object sender, EventArgs e)
        {
            ...
            {
                string message = "Поле \"ID типа сырья\" не заполнено";
            ...
            else
            {
                ...
                try
                {
                    ...
                    cmd.CommandText = "DELETE FROM types_of_raw WHERE idtypes_of_raw = @id;"; //если таблица отсутствует, создает
