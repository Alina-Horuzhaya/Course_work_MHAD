...
{
    public partial class devisions : Form
    {
        ...
        private void LoadData()
        {
            ...
            {
                conn.Open();
                string query = "SELECT * FROM devisions ORDER BY iddevisions";
        ...
        private void button_export_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialoge.FileName = "Сводка подразделений";
