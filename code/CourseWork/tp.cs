...
namespace CourseWork
{
    public partial class tp : Form  
    {
        ...
        private void LoadData()
        {
            ...
            {
                conn.Open();
                string query = "SELECT * FROM tp ORDER BY idtp";
                ...
                while (rdr.Read())
                {
                    ...
                    data[data.Count - 1][2] = rdr[2].ToString().Split(' ')[0]; //прочитываем 2 столбец data 
        ...
        private void button_export_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialoge.FileName = "ТП (технологический процесс)";
