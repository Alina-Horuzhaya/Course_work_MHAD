...
{
    public partial class types_of_raw : Form
    {
        ...
        private void LoadData()
        {
            ...
            {
                conn.Open();
                string query = "SELECT * FROM types_of_raw ORDER BY idtypes_of_raw";
                ...
                while (rdr.Read())
                {
                    ...
                    data[data.Count - 1][2] = rdr[2].ToString(); //прочитываем 2 столбец idprovider
        ...
        private void button_export_Click(object sender, EventArgs e)
        {
            ...
            saveFileDialoge.FileName = "Типы сырья";
        ...
        private void button_add_Click(object sender, EventArgs e)
        {
            ...
            add_types_raw frm14 = new add_types_raw();
            dr = frm14.ShowDialog();
            refresh_window();
        }
        ...
        {
            DialogResult dr = new DialogResult();
            del_types_raw frm14 = new del_types_raw();
            dr = frm14.ShowDialog();
            refresh_window();
        }
